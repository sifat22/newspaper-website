        ...
        <div class="row">
            <div class="col-md-8">
                <ul class="breadcrumb">
                 ...
                 <!--show শিক্ষাঙ্গন-->
                <?php 
                $getsingleedu=$post->getEduNews();
                if($getsingleedu){
                    while($result=$getsingleedu->fetch_assoc()){
                ...
                <div class="imagecontent">
                   ...
                   <?php echo $result['title']; ?>
                    ...
                    <?php echo $fm->textShorten($result['body'],600); ?>
                    </p></a>
                </div>
                    <?php } } ?>
