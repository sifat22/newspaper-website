        ...
        <div class="row">
            <div class="col-md-8">
                <ul class="breadcrumb">
                 ...
                 <!--show অপরাধ-->
                <?php 
                $getsinglefinancenew=$post->getOporadhNews();
                           ...
                           <div class="row" >
                               <div class="col-md-6">
                                     <div class="small-imgae" style="margin-top: 15px; width:100px; height:70px;">
                                         <a href="details.php?postid=<?php echo $result['postId']; ?>"><img style="width: 110px;  height:80px;" src="admin/<?php echo $result['image']; ?>" alt="" class="img-resposinve"></a>
                                     </div>
                               </div>
                               <div class="col-md-6">
