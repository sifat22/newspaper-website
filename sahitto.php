        ...
        <div class="row">
            <div class="col-md-8">
                <ul class="breadcrumb">
                 ...
                 <!--show সাহিত্য-->
                <?php 
                $getsinglefinancenew=$post->getSahittoNews();
                ...
                <div class="content-area">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="post">
                           <div class="small-imgae" style="margin-top: 15px;">
                           <a href="details.php?postid=<?php echo $value['postId']; ?>"><img src="admin/<?php echo $value['image']; ?>" sstyle="width: 200px;height:100px;"  alt="" class="img-resposinve"></a>
                           </div>
                           <div class="small-image-content">
                               <a href="details.php?postid=<?php echo $value['postId']; ?>" class="pera" style="margin-top:5px;  text-align:left;">
                               <?php echo $value['title']; ?>
                        ...
                        <div class="col-md-4" >
                            <div class="col-md-12">
                                <?php 
                                 $getlatestpost=$post->getSahittoPost();
                                 if($getlatestpost){
